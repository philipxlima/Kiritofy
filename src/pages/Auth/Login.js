  ...
  const loginFormSubmitHandler = async e => {
    ...
    try {
      if (!formHasError) {
        ...
        toast.success("Login efetuado com sucesso.", toastOptions);
  ...
  return (
    <Fragment>
      ...
      <Content className="flex-column flex-center">
        <p className=" text-large white">Para continuar, efetue login em Kiritofy.</p>
        <form className="form mg-t-3" onSubmit={loginFormSubmitHandler}>
          ...
          <Input
            ...
            emptyAndHasErrorMessage={"Por favor, digite seu endereço de e-mail"}
            hasError={emailHasError}
            hasErrorMessage={"Este e-mail é inválido."}
          ...
          <Input
            ...
            emptyAndHasErrorMessage={"Insira sua senha"}
            hasError={passwordHasError}
