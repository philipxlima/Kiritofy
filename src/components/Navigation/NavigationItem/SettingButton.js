    ...
    <Popup
      ...
      triggerContent={
        <MenuItem
          ...
          <span style={{marginLeft: "12px"}}>Criador</span>
        </MenuItem>
      }
      content={
        <Fragment>
          <RowMusicShelf
            ...
            type="contributor"
            data={{
              title: "Philip Xavier de Lima",
              thumbnail: "/assets/images/phil.jpg",
            }}
            github="https://github.com/PhilipXLima"
            linkedIn="https://www.linkedin.com/in/philipx/"
            url="https://www.instagram.com/philipxlima/"
          />
        </Fragment>
      }
    />
